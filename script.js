...
function MapChoise(map) {
  ...
  const def_sec2 = [
    { id: 0, name: "waterfall", os: 2, color: 0 }, //Водопад! os = 2 - флаг для используемой базы
    { id: 1, name: "A5A", os: 2, color: 0 }, // нумерация секторов с единицы!
    { id: 2, name: "A5D", os: 2, color: 0 },
    { id: 3, name: "B5C", os: 2, color: 0 },
    { id: 4, name: "C5B", os: 2, color: 0 },
    { id: 5, name: "D5A", os: 2, color: 0 },
    { id: 6, name: "D5D", os: 2, color: 0 },
    { id: 7, name: "E5C", os: 2, color: 0 },
    { id: 8, name: "F5B", os: 2, color: 0 },
    { id: 9, name: "X1X", os: 3, color: 0 },
    { id: 10, name: "A4A", os: 2, color: 0 }, // 10
    { id: 11, name: "A3A", os: 2, color: 0 },
    { id: 12, name: "A2A", os: 3, color: 0 },
    { id: 13, name: "A5B", os: 2, color: 0 },
    { id: 14, name: "A4B", os: 2, color: 0 },
    { id: 15, name: "A3B", os: 2, color: 0 },
    { id: 16, name: "A5C", os: 2, color: 0 },
    { id: 17, name: "A4C", os: 2, color: 0 },
    { id: 18, name: "B2A", os: 3, color: 0 },
    { id: 19, name: "B3A", os: 2, color: 0 }, //19
    { id: 20, name: "B4A", os: 2, color: 0 },
    { id: 21, name: "B5A", os: 2, color: 0 },
    { id: 22, name: "B3B", os: 2, color: 0 },
    { id: 23, name: "B4B", os: 2, color: 0 },
    { id: 24, name: "B5B", os: 2, color: 0 },
    { id: 25, name: "B4C", os: 2, color: 0 },
    { id: 26, name: "B5D", os: 2, color: 0 },
    { id: 27, name: "C2A", os: 3, color: 0 },
    { id: 28, name: "C3A", os: 2, color: 0 },
    { id: 29, name: "C4A", os: 2, color: 0 },
    { id: 30, name: "C5A", os: 2, color: 0 },
    { id: 31, name: "C3B", os: 2, color: 0 },
    { id: 32, name: "C4B", os: 2, color: 0 },
    { id: 33, name: "C5C", os: 2, color: 0 },
    { id: 34, name: "C4C", os: 2, color: 0 },
    { id: 35, name: "C5D", os: 2, color: 0 },
    { id: 36, name: "D2A", os: 3, color: 0 },
    { id: 37, name: "D3A", os: 2, color: 0 },
    { id: 38, name: "D4A", os: 2, color: 0 },
    { id: 39, name: "D3B", os: 2, color: 0 },
    { id: 40, name: "D4B", os: 2, color: 0 },
    { id: 41, name: "D5B", os: 2, color: 0 },
    { id: 42, name: "D4C", os: 2, color: 0 },
    { id: 43, name: "D5C", os: 2, color: 0 },
    { id: 44, name: "E2A", os: 3, color: 0 },
    { id: 45, name: "E3A", os: 2, color: 0 },
    { id: 46, name: "E4A", os: 2, color: 0 },
    { id: 47, name: "E5A", os: 2, color: 0 },
    { id: 48, name: "E3B", os: 2, color: 0 },
    { id: 49, name: "E4B", os: 2, color: 0 },
    { id: 50, name: "E5B", os: 2, color: 0 },
    { id: 51, name: "E4C", os: 2, color: 0 },
    { id: 52, name: "E5D", os: 2, color: 0 },
    { id: 53, name: "F2A", os: 3, color: 0 },
    { id: 54, name: "F3A", os: 2, color: 0 },
    { id: 55, name: "F4A", os: 2, color: 0 },
    { id: 56, name: "F5A", os: 2, color: 0 },
    { id: 57, name: "F3B", os: 2, color: 0 },
    { id: 58, name: "F4B", os: 2, color: 0 },
    { id: 59, name: "F5C", os: 2, color: 0 },
    { id: 60, name: "F4C", os: 2, color: 0 },
    { id: 61, name: "F5D", os: 2, color: 0 },
  ];
  nmap = map;
  if (map == 1) {
